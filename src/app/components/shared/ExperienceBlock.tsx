...
export default function ExperienceBlock({ workExperience, inputView }: { workExperience: WorkExperienceType; inputView: boolean }) {
    ...
    return (
        <div className="section-block" style={inputView ? { fontSize: defaultSize } : { fontSize: theme.size }}>
            ...
            <div className="section-description">{workExperience.description}</div>
        </div>
    );
}
